...
public class TestXMLDataLoader {
	...
	@Test
	public void getItemsDataFromXMLLoader(@Param(name="libraryId")String libraryId , @Param(name="itemId")String itemId , @Param(name="itemType")String itemType , @Param(name="expectedItems")String expectedItems){
